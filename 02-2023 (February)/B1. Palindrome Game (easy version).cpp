...
void solve() {
    ...
    // cout<<ans<<nl;
    ll alice=0,bob=0;
    bool flag=true,a=true,b=true,check=false;
    fl(j,0,n){
        if(j==0){
            // ll k=1;
            // fl(i,0,n){
            ...
            if(idx!=string::npos)
                s[idx]='1';
            // cout<<idx<<sp;
            alice++;a=false;flag=false;
            if(s==ans){
                check=true;
                break;
            }
        }else{
            if(isPalindrome(s,0,s.size()-1) && s!=ans){
                // ll k=1;
                // fl(i,0,n){
                //     if(s[i]=='0' && k--) {
                //         s[i]='1';break;
                ...
                if(!isPalindrome(s,0,s.size()-1)){
                    if(flag){
                        if(b){
                            bob+=0;b=false;a=true;
                        }else if(a){
                            alice+=0;a=false;b=true;
                        }
                        flag=false;
                    }else{
                        // ll k=1;
